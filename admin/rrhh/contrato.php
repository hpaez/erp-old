...
<html lang="en">
	<head>
		<title>PNKS Recurso Humano - Contrato & Finiquito</title>
	...
	<body class="menubar-hoverable header-fixed menubar-first menubar-visible menubar-pin">
                            ...
                            <div class="col-lg-offset col-md-12">
                                <div class="card">
                                    <div class="card-head style-primary">
										<header>Descargar Contrato & Finiquito</header>
									</div>
                                    <form class="form form-validate floating-label" id="form1" name="form1" action="" accept-charset="utf-8" method="post" novalidate>
                                        <div class="card-body">
                                            <div class="form-group">
                                                <div>
                                                    <label class="radio-inline radio-styled">
														<input type="radio" name="tipo" value="Contrato" id="contrato" checked><span>Contrato</span>
													</label>
													<label class="radio-inline radio-styled">
														<input type="radio" name="tipo" value="Finiquito" id="finiquito"><span>Finiquito</span>
													</label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <select id="rut" name="rut" class="form-control" required>
                                                    <option value="">&nbsp;</option>
                                                    <?php
                                                        $ru=mysql_query("select rut from trabajador");
                                        ...
                                        <div class="card-actionbar">
                                            <div class="card-actionbar-row">
                                                <button type="button" class="btn btn-flat btn-primary ink-reaction" name="enviar" id="enviar" onClick="validarPDF()">Descargar</button>
                                            </div>
			...
			<div id="menubar" class="menubar-first">
				...
				<div class="menubar-scroll-panel">
					...
					<ul id="main-menu" class="gui-controls">
                        ...
                        <!-- BEGIN EMAIL -->
                        <li>
							<a href="contrato.php" class="active">
        ...
        <script src="../../js/enviarpdf.js"></script>
		<!-- END JAVASCRIPT -->
	</body>
</html>