...
<html lang="en">
	<head>
		<title>PNKS Recurso Humano - Planificacion de Vacaciones</title>
				...
				<div class="menubar-scroll-panel">
					...
					<ul id="main-menu" class="gui-controls">
						...
						<li class="gui-folder">
							...
							<!--start submenu -->
							<ul>
                            	<li><a href="certificado.php"><span class="title">Certificados</span></a></li>
                            	<li><a href="contrato.php"><span class="title">Contratos y Finiquitos</span></a></li>
                                <li><a href="fvacacion.php"><span class="title">Ficha de Vacaciones</span></a></li>
                                <li><a href="renta.php"><span class="title">Historial Rentas</span></a></li>
                                <li><a href="asistencia.php"><span class="title">Libro de Asistencia</span></a></li>
                                <li><a href="licencia.php"><span class="title">Licencias</span></a></li>
								<li><a href="calculo.php"><span class="title">Modelo de Calculo</span></a></li>
                                <li><a href="pvacacion.php" class="active"><span class="title">Planificacion de Vacaciones</span></a></li>
								<li><a href="imposicion.php"><span class="title">Planillas de Imposición</span></a></li>
							</ul><!--end /submenu -->
						</li><!--end /menu-li -->
                        <!-- END EMAIL -->
					</ul><!--end .main-menu -->
