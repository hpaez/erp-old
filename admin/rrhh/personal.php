...
<html lang="en">
	<head>
		<title>PNKS Recurso Humano - Ficha del Personal</title>
			...
			<div id="content">
				<section>
					<div class="section-body">
						<div class="row">
                            <div class="col-lg-offset col-lg-12">
								<div class="card">
                                    <div class="card-head style-primary">
										<header>Ficha de Personal</header>
									</div>
                                	<div class="card-body">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            while($row = mysql_fetch_array($result)){
                                                                echo "<tr>";
                                                                echo "<td>";
                                                                if(file_exists('../../img/usuarios/'.str_replace('-','',str_replace('.','',$row['rut'])).'.png')){
                                                                    echo "<img src='../../img/usuarios/".str_replace('-','',str_replace('.','',$row['rut'])).".png' alt='' width='60' height='60' />";
                                                                } else {
                                                                    echo "<img src='data:image/svg+xml;base64,' width='60' height='60'/>";
                                                                }
                                                                echo "<td>".$row["rut"]."</td>";
                                                                echo "<td>".$row["nombre"]."</td>";
                                                                echo "<td>".$row["apellidoPaterno"]." ".$row["apellidoMaterno"]."</td>";
                                                                echo "<td>".$row["sexo"]."</td>";
                                                                echo "<td>".$row["cargo"]."</td>";
                                                                echo "<td>".$row["cargaFamiliar"]."</td>";
                                                                echo "<td>".$row["isapre"]."</td>";
                                                                echo "<td>".$row["afp"]."</td>";
                                                                echo "<td>".$row["caja"]."</td>";
