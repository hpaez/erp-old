...
<html lang="en">
	<head>
		<title>PNKS Portal Empleado - Asistencia</title>
	...
	<body class="menubar-hoverable header-fixed menubar-first menubar-visible menubar-pin">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="table-responsive">
                                                <table id="datatable1" class="table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $query = "select * from asistencia where idTrabajador='".$_SESSION['rut_user']."' and fecha between '".fecha_bd($_POST['start'])."' and '".fecha_bd($_POST['end'])."'";
                                            ...
                                            <form class="form form-validate floating-label" action="<?php echo $_SERVER['PHP_SELF']; ?>" accept-charset="utf-8" method="post" novalidate>
                                                ...
                                                <div class="card-actionbar">
                                                    <div class="card-actionbar-row">
                                                        <button type="submit" class="btn btn-flat btn-primary ink-reaction" id="enviar" name="enviar">Buscar Licencia</button>
                                                    </div>
        ...
        <script src="../../js/core/demo/DemoFormComponents2.js"></script>
		<!-- END JAVASCRIPT -->
	</body>
</html>