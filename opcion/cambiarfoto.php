...
if(isset($_POST['enviar'])){
        ...
        $foto=str_replace('-','',str_replace('.','',$_SESSION['rut_user'])).".png";
        move_uploaded_file($_FILES['file']['tmp_name'],"../img/usuarios/".$foto);
        echo "<script>alert('La foto fue subida $nombre_file');</script>";
		echo"<script>window.location.href='cambiarfoto.php';</script>";
}
?>
<html lang="en">
	<head>
		<title>PNKS - Cambiar Foto de Perfil</title>
                        	...
                        	<div class="col-lg-offset-1 col-md-8">
                                <div class="card">
                                    <div class="card-head style-primary">
										<header>Cambiar Foto de Perfil</header>
									</div>
                                    <form class="form dropzone form-validate floating-label" id="file-submit" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <?php
                                                if(file_exists('../img/usuarios/'.$_SESSION['foto_user'])){
                                            ?>
                                                <span class="alert alert-info" id="file-info">Actualice su foto de perfil.</span>
                                            <?php
                                                } else {
                                            ?>
			...
			<div id="menubar" class="menubar-first">
				...
				<div class="menubar-scroll-panel">
					...
					<ul id="main-menu" class="gui-controls">
                        ...
                        <!-- BEGIN EMAIL -->
						<li>
							<a href="cambiarfoto.php" class="active">
