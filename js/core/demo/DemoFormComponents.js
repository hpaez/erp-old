(function (namespace, $) {
	...
	p._initInputMask = function () {
		...
		$(".form-control.peso-mask").inputmask('$ 999.999.999', {numericInput: true, rightAlignNumerics: false});
	...
	p._initDatePicker = function () {
		...
		$('#demo-date').datepicker({autoclose: true, todayHighlight: true, language: "es"});
		$('#demo-date-month').datepicker({autoclose: true, todayHighlight: true, minViewMode: 1, language: "es"});
		$('#demo-date-format').datepicker({autoclose: true, todayHighlight: true, format: "yyyy/mm/dd", language: "es"});
		$('#demo-date-range').datepicker({todayHighlight: true, startDate: "today", endDate: "+20d", language: "es"});
		$('#demo-date-inline').datepicker({todayHighlight: true, language: "es"});
	};
