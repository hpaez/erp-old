...
<html lang="en">
	<head>
		<title>PNKS Recurso Humano - Control de Vacaciones</title>
                            ...
                            <div class="col-lg-offset col-md-12">
								<div class="card">
                                    <div class="card-head style-primary">
										<header>Control de Vacaciones</header>
									</div>
									<div class="card-body">
                                        <table id="datatable1" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                    $query = "select * from solicitud_vacacion";
                                                    ...
                                                    if($total>=1){
                                                        while($row = mysql_fetch_array($result)){
                                                            ...
                                                            echo "<td>".$row["tipoEmpleado"]."</td>";
                                                            echo "<td>".$row["motivo"]."</td>";
                                                            echo "<td>".$row["estado"]."</td>";
                                                            if($row["estado"]=='Pendiente'){
                                                                echo "<td><a href='estado.php?id=".$row['idVacacion']."&opcion=3'><i class='fa fa-thumbs-up'></i></a>&nbsp;<a href='estado.php?id=".$row['idVacacion']."&opcion=4'><i class='fa fa-thumbs-down'></i></a></td>";
                                                            } else if ($row["estado"]=='Aprobado'){
                                                                echo "<td><a href='estado.php?id=".$row['idVacacion']."&opcion=4'><i class='fa fa-thumbs-down'></i></a></td>";
                                                            } else {
                                                                echo "<td><a href='estado.php?id=".$row['idVacacion']."&opcion=3'><i class='fa fa-thumbs-up'></i></a></td>";
                                                            }
                                                            echo "</tr>";
                                                        }
                                                    }
			...
			<div id="menubar" class="menubar-first">
				...
				<div class="menubar-scroll-panel">
					...
					<ul id="main-menu" class="gui-controls">
                        ...
                        <!-- BEGIN EMAIL -->
						<li>
							<a href="vacacion.php" class="active">
								<div class="gui-icon"><i class="md md-web"></i></div>
