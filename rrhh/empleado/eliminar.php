...
if(isset($_POST['enviar'])){
	$csql="update trabajador set estado='2' where rut='".$_POST['rut']."'";
	mysql_query($csql);
...
<html lang="en">
	<head>
		<title>PNKS Recurso Humano - Eliminar Empleado</title>
                            ...
                            <div class="col-lg-offset col-md-12">
                                <div class="card">
                                    <div class="card-head style-primary">
										<header>Eliminar Empleado</header>
									</div>
                                    <form class="form form-validate floating-label" action="<?php echo $_SERVER['PHP_SELF']; ?>" accept-charset="utf-8" method="post" enctype="multipart/form-data" novalidate>
                                        <div class="card-body">
                                            <div class="form-group">
                                                <select id="rut" name="rut" class="form-control" required>
                                                    <option value="">&nbsp;</option>
                                                    <?php
                                                        $ru=mysql_query("select rut from trabajador where estado='1' order by 1");
                                        ...
                                        <div class="card-actionbar">
                                            <div class="card-actionbar-row">
                                                <button type="submit" class="btn btn-flat btn-primary ink-reaction" name="enviar" id="enviar">Eliminar Empleado</button>
                                            </div>
					...
					<ul id="main-menu" class="gui-controls">
						...
						<li class="gui-folder">
							...
							<ul>
                                ...
                                <li><a href="eliminar.php" class="active"><span class="title">Eliminar Empleado</span></a></li>
							</ul><!--end /submenu -->
						</li><!--end /menu-li -->
                        <!-- END EMAIL -->
                        <!-- BEGIN EMAIL -->
