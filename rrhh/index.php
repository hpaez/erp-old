...
<html lang="en">
	<head>
		<title>PNKS Recurso Humano - Inicio</title>
                                	...
                                	<div class="card-body">
                                        <div class="table-responsive">
                                            <table id="datatable" class="table table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $query = "select nombre,apellidoPaterno,apellidoMaterno,cargo,rut,sexo from trabajador where estado='1'";
                                                        ...
                                                        echo "<tr><td><b>Número de Trabajadores: " . $total ."</b></td></tr>";
							...
							<div class="col-lg-offset col-md-4">
								<div class="card">
									...
									<div class="card-body">
                                        ...
                                        <span style="float:right"><em class="text-caption"><a href="">ver más...</a></em></span>
